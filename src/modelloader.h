...
struct Node
{
    ...
    QVector<QSharedPointer<modelMesh> > meshes;
    QVector<Node> nodes;
};
...
public:
    ...
    inline bool isEmpty() { return m_vertices.isEmpty(); }
...
private:
    ...
    QSharedPointer<modelMesh> processMesh(aiMesh *mesh);
    ...
    QVector<QSharedPointer<modelMesh> > m_meshes;
